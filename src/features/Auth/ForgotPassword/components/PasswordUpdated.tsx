...
const PasswordUpdated = (props: Props) => {
    ...
    return (
        <div className='py-[20px]  px-[20px] h-full flex flex-col items-center '>
            ...
            <div className='w-full z-50 max-w-[388px] mt-[30px] flex flex-col items-center'>
                ...
                <h1 className='max-w-[174px] text-[36px] font-bold leading-[44px] tracking-[0.15px] text-white mt-[5px]'> {t("PasswordUpdated")}</h1>
                <div onClick={() => {
                    router.push("/sign-in")
                }} className='rounded-[35px]  cursor-pointer mt-[40px] w-full max-w-[277px] gap-[12px] h-[48px] bg-[#357EF8]  text-[13px] font-semibold leading-[16.38px] text-white flex flex-col justify-center items-center'>
                    {t("BackLogin")}
                </div>
            </div>
        </div>
