...
const TabBar = ({ page, language }: Props) => {
    ...
    return (
        <div className='fixed bottom-0  w-full max-w-[388px] '>
            <div className='flex justify-between  bg-black bg-opacity-[75%] pb-[10px] px-[10px] items-center'>
                <div onClick={() => {
                    if (language) {
                        router.push("/profile", { locale: language })
                    } else {
                        router.push("/profile")
                    }
                ...
                <div onClick={() => {
                    if (language) {
                        router.push("/explore", { locale: language })
                    } else {
                        router.push("/explore")
                    }
                ...
                <div onClick={() => {
                    if (language) {
                        router.push("/challenge", { locale: language })
                    } else {
                ...
                <Popover>
                    ...
                    <PopoverContent className='flex flex-col space-y-2 bg-black'>
                        ...
                        <h1 onClick={() => {
                            if (language) {
                                router.push("/leaderboard", { locale: language })
                            } else {
