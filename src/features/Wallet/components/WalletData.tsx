            ...
            <div className='w-[50%] flex flex-col space-y-[8px] '>
                <div className='w-full cursor-pointer hover:scale-x-105 rounded-[16px] bg-[#EDEDED] px-[16px] py-[16px] h-[50%] grid place-content-center'>
                    <div className='flex items-center space-x-[12px]'>
                        <Image className='w-[42px] h-[42px]' alt='check down' width={500} height={500} src={"/tab/checkdown.png"} />
                        <h1 className='text-[16px] font-bold leading-[24px] text-[#202226]'>Deposit</h1>
                    </div>
                </div>
                ...
                <div onClick={() => {
                    ...
                    <div className='flex items-center space-x-[12px]'>
                        <Image className='w-[42px] h-[42px]' alt='check down' width={500} height={500} src={"/tab/checkup.png"} />
                        <h1 className='text-[16px] font-bold leading-[24px] text-[#202226]'>Withdraw</h1>
                    </div>
                </div>
            </div>
        </div>
